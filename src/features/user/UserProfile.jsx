...
export default function UserProfile() {
  ...
  useEffect(() => {
    ...
    const storedEmail =
      localStorage.getItem("userEmail") || "hello@deliveroo.ke";
  ...
  const openWhatsApp = () => {
    ...
    window.open(
      `https://wa.me/254700123456?text=${encodeURIComponent(message)}`,
      "_blank",
    );
  };
          ...
          <div className="flex items-center gap-8 w-full">
            ...
            <div>
              ...
              <p className="text-[11px] font-bold uppercase tracking-[0.4em] text-gray-400 mt-2">
                Active Session:{" "}
                <span className="text-black font-black">{userData.name}</span>
              </p>
            </div>
          </div>
            ...
            >
              ...
              <div>
                <p className="text-[9px] font-black uppercase tracking-[0.3em] text-black">
                  Vantage Shield Active
                </p>
                <p className="text-[8px] font-bold uppercase text-gray-400 tracking-tighter">
                  Verified Secure Portal Connection
                </p>
              </div>
            </motion.div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          <div className="lg:col-span-8 space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <motion.div
                whileHover={{ y: -5 }}
                className="bg-white p-10 rounded-[50px] border border-gray-100 shadow-sm group border-b-4 border-b-transparent hover:border-b-yellow-500 transition-all"
              >
            ...
            <div className="bg-white p-12 rounded-[60px] border border-gray-100 shadow-sm relative overflow-hidden">
              <div className="flex items-center gap-3 mb-12">
                ...
                <h3 className="text-xs font-black uppercase tracking-[0.4em] text-gray-300 italic">
                  User Credentials
                </h3>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-y-12 gap-x-12">
                {[
                  ...
                  {
                    label: "Fleet ID",
                    val: "LGT-" + (2000 + userData.ordersThisMonth),
                    icon: <Zap size={14} />,
                  },
                  {
                    label: "Registration",
                    val: userData.memberSince,
            ...
            >
              <div>
                <h3 className="text-3xl font-black tracking-tighter mb-2 italic uppercase">
                  Dispatch New Parcel
                </h3>
                <p className="text-xs font-bold text-black/60 uppercase tracking-widest">
                  Instant connection to our premium courier network.
                </p>
              </div>
              <motion.button
          ...
          <div className="lg:col-span-4 space-y-8">
            <div className="bg-white p-12 rounded-[60px] border border-gray-100 shadow-sm">
              <h3 className="text-xs font-black uppercase tracking-[0.4em] text-gray-300 mb-10 italic">
                Intelligence Center
              </h3>
              <div className="space-y-6">
                <div className="p-8 bg-gray-50 rounded-[40px] border border-gray-100 text-center group hover:bg-black transition-all">
                  ...
                  <p className="text-2xl font-black tracking-tighter italic text-[#111] group-hover:text-white transition-colors">
                    +254 700 123 456
                  </p>
                </div>
