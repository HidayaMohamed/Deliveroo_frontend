      ...
      <div className="w-full max-w-md">
        ...
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.5em] text-yellow-600">Welcome Back</span>
          </div>
          <h1 className="text-5xl font-black tracking-tighter">
            Sign <span className="italic">in</span><span className="text-yellow-500">.</span>
          </h1>
        </div>
        ...
        <div className="mt-8 text-center space-y-4">
          <p className="text-sm font-bold text-gray-400">
            ...
            <Link to="/register" className="text-black font-black hover:text-yellow-600 transition-colors underline decoration-yellow-500 decoration-2 underline-offset-4">
              Create one
            </Link>
          </p>
        </div>
        ...
        <div className="flex items-center justify-center gap-2 mt-10">
          ...
          <p className="text-[9px] text-gray-300 font-bold uppercase tracking-widest">Secure 256-bit encrypted login</p>
        </div>
      </div>
    </div>
  );
