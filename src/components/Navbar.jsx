  ...
  return (
    <nav className="sticky top-0 z-[100] bg-white/70 backdrop-blur-md border-b border-gray-100/50 px-[5%] py-3 flex justify-between items-center">
      ...
      <div className="flex items-center gap-8">
        ...
        <Link
          to="/orders/new"
          className="flex items-center gap-2 bg-[#111] text-white px-5 py-2 rounded-full text-[10px] font-bold uppercase tracking-widest hover:bg-yellow-500 transition-all active:scale-95 shadow-sm"
        >
        ...
        <Link
          to="/orders"
          className={`hidden lg:flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest transition-all ${location.pathname === "/orders" ? "text-black" : "text-gray-400 hover:text-black"}`}
        >
        ...
        <div className="relative flex items-center gap-3 pl-8 border-l border-gray-100">
          ...
          {dropdownOpen && (
            <div className="absolute right-0 top-full mt-4 w-60 bg-white border border-gray-100 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] rounded-[28px] py-3 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
              <Link
                to="/profile"
                className="flex items-center gap-3 px-6 py-4 text-[10px] font-bold uppercase tracking-widest text-gray-500 hover:text-black hover:bg-gray-50 transition-all"
              >
